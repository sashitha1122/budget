    ...
    <div className='d-flex justify-content-center alert alert-light border-black'style={{width: '750px' }}>
      <div className=''style={{width: '700px' }}>
        <div className="d-flex justify-content-between">
          <h2 className="text-success" style={{ fontStyle: 'italic' }}>Expenses</h2>
          <button onClick={handleClickOpen} className="fs-6 btn btn-outline-success justify-content-center "style={{ fontStyle: 'italic' }}>Create Expense</button>
        </div>
