...
const AddBudgetForm = () => {
    return (
      <div className="d-flex justify-content-center">
           <div className="alert alert-success w-50" style={{ height: '400px' }} role="alert">
            <h2 className='text-center'>  Create Budget</h2>
            <Form method="post" class="">
               <div className="">
                <label className="fs-5 mt-3" htmlFor="newBudget">Budget Name </label>
                <input type="text" class="form-control mt-3" name="newBudget" id="newBudget" placeholder="e.g., Groceries" required />
               </div>
               <div class="mt-3">
                <label className="fs-5 mt-3" htmlFor="newBudgetAmount">Amount </label>
               ...
               <button type="submit" className=" mt-3 btn btn-dark">Create Budget</button>   
               </div> 
            </Form>
          </div>
      </div>  
